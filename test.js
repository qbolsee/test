...
// add parts
let ic1 = board.add(SOIC8, {translate:  [x+0.22, y+0.38]});
let c1 = board.add(C1206, {translate: [ic1.padX("center"), ic1.padY("1")+0.12], rotate:0});
let r1 = board.add(R1206, {translate: [ic1.padX("center"), ic1.padY("4")-0.12], rotate:0});
let led1 = board.add(LED1206, {translate: [r1.padX("center"), r1.padY("center")-0.12], rotate:0});
let j1 = board.add(FTDI, {translate: [x+width-0.2, ic1.padY("center")-0.05]});
let r2 = board.add(R1206, {translate: [j1.padX("center")-.12, j1.padY("TX")-0.05], rotate:  90});
...
board.wire([ic1.pad("8"),
            [ic1.padX("8"), c1.padY("center")],
            c1.pad("2")], w)

board.wire([ic1.pad("5"),
            [ic1.padX("5"), r1.padY("center")],
            r1.pad("2")], w)
...
board.wire([c1.pad("1"),
            ...
            [j1.padX("center")+0.1, j1.padY("GND")+0.08],
            [j1.padX("center")+0.1, j1.padY("VCC")],
            j1.pad("VCC")], w)
...
if (output == "interior") {
  ...
  functions = [
    {
      f: frep.reflect_x(board.getLayer("B.Cu"), 2*x+width),
      color: [1, 1, 1, 1]
    }    
  ];
  ...
  functions = [
    {
      f: board.getLayer("componentLabels"),
      color: [0.1, 1, 0.1, .7]
    },
    {
      f: board.getLayer("padLabels"),
      color: [1, 0.27, 0.07, .8]
    },
    {
      f: board.getLayer("drill"),
